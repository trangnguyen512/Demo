...
const Home = () => {
  return (
    <>
      <section className=" h-full md:h-[calc(100vh-200px)] xl:h-full w-full overflow-hidden xl:flex xl:justify-center xl:items-center">
        <div className="h-[60vh] md:full xl:h-[60vh] flex items-center justify-center xl:flex xl:items-center">
