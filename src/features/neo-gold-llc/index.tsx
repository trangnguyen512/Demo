...
const NeoGoldLLC = () => {
  ...
  return (
    <div className="min-h-[800px] h-[calc(100vh-130px)] w-full relative">
      ...
      <div className="main-content h-[97%] w-full flex flex-col md:grid md:grid-flow-row lg:grid-flow-col md:grid-rows-6 lg:grid-rows-none lg:grid-cols-2 gap-2 lg:gap-10">
        <div className="col-left h-[60%] md:h-full md:row-start-1 md:row-end-6 lg:row-span-1 lg:col-span-1 flex flex-col items-start justify-start">
          <div className="title h-0 lg:h-12"></div>
          <div className="content flex flex-col gap-8 h-full w-full">
            <div
              data-aos="fade-left"
              data-aos-delay="700"
              className="top h-[22%] w-full flex flex-col items-start justify-center bg-white bg-neo-gold-money"
            >
              <div
                data-aos="fade-up"
                data-aos-delay="300"
                className="top h-1/4 text-primary_text  font-zenkaku w-[80%] px-4 bg-[#00020F] flex items-center justify-start "
              >
            ...
            <div className="bottom h-[65%] w-full relative z-10 bg-shadow-custom">
              <div
                ...
                className="text pt-4 px-4 font-medium text-[10px] md:text-md_size_regular"
              >
                有限責任社員権の募集
              </div>
              <div
                // animateIn="fadeInRight_Chart"
        ...
        <div className="col-right p-2 md:p-0 lg:p-0 h-[20%] md:h-full md:row-start-6 md:row-end-7 lg:row-span-1 lg:col-span-1  flex flex-col items-start justify-start relative">
          <div
            data-aos="fade-down"
            data-aos-delay="300"
          ...
          <div className="flex flex-col gap-4 mt-7">
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="1500"
              className="fixed hidden md:block opacity-50 lg:hidden z-[1] h-[250px] w-[300px] left-0 bottom-0"
            >
      ...
      <div
        data-aos="fade-down"
        data-aos-delay="2000"
        className="text-bottom hidden lg:flex items-center justify-end h-[3%] md:bottom-0 lg:bottom-5 relative z-10 w-full"
      >
